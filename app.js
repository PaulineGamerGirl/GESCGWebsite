    ...
    html += `
      <div class="immersive-card-wrapper" id="immersive-card-note" data-index="note">
        ...
        <div class="immersive-glass-card animate-in" style="animation-delay: ${delay + 0.1}s">
          ...
          <p style="margin-bottom: 1.25rem; line-height: 1.8;">Everything you see on this platform <span class="lav-em">only becomes real if the College of Science chooses us</span>. These are not promises handed down from a podium. They are plans built from the ground up, shaped by real conversations with real students, and they remain open to change — because <em>good governance listens</em>.</p>

          <p style="margin-bottom: 1.25rem; line-height: 1.8;">If elected, each officer will receive a general brief on their responsibilities — a <span class="lav-em">starting point, not a script</span>. The best ideas we've ever seen came from people who were trusted to think, not just told to comply. We will never reduce our officers to order-takers. You bring your creativity, your instincts, your way of doing things — and together we figure out the best path forward.</p>

          <p style="margin-bottom: 1.25rem; line-height: 1.8;">Do you have thoughts on how this structure could be better? Does something feel off, missing, or overcomplicated? <span class="lav-em">Go to the Suggestions tab</span>. That space exists precisely for this. No idea is too small. No critique is too blunt. We are building this in public and we mean it.</p>
          ...
          <div style="margin: 2rem 0; padding: 1.5rem; border-left: 3px solid #d8b4fe; background: rgba(216, 180, 254, 0.05); border-radius: 0 8px 8px 0;">
            <p style="line-height: 1.8; margin: 0;">This administration is <span class="lav-em">non-partisan</span>. We do not care what organization you belong to, what your political leaning is, or where you came from before you walked into this college. If you want to serve, <em>you are welcome here</em>. What we will always ask for — from ourselves and from everyone we work with — is <span class="lav-em">creativity and accountability</span>. No shortcuts. No vanishing acts. No empty timelines.</p>
          </div>

          <p style="margin-bottom: 1.25rem; line-height: 1.8;">And if a project does not push through — because things happen, because life is complicated, because administration said no — we will not pretend it didn't exist. <span class="lav-em">A formal justification letter will be published here</span>, visible to every student, explaining exactly what happened and why. You deserve to know.</p>
